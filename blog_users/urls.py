...
urlpatterns = [
    ...
    path('password_reset/done/', PasswordResetDoneView.as_view(
        template_name='blog_users/password_reset_done.html'),
        name='password_reset_done'
    ),
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(
        template_name='blog_users/password_reset_confirm.html',
        success_url='/blog_users/reset/done/'),
        name='password_reset_confirm'
    ),
    path('reset/done/', PasswordResetCompleteView.as_view(
        template_name='blog_users/password_reset_complete.html'),
    ...
    path('password_change/done/', PasswordChangeDoneView.as_view(
        template_name='blog_users/password_change_done.html'),
